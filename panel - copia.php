...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        <div class="card">
          <img src="./images/GP1.png" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="card">
          <img src="./images/GP2.jpg" class="card-img-top" alt="...">
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card">
          <img src="./images/GP3.png" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="card">
          <img src="./images/GP4.png" class="card-img-top" alt="...">
          <div class="card-body">
